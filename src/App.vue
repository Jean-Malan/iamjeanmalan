<template>
  <div class="min-h-screen bg-white">
    <!-- Navigation -->
    <nav class="px-4 sm:px-6 lg:px-8 border-b border-gray-200">
      <div class="max-w-7xl mx-auto">
        <div class="flex items-center justify-between h-16">
          ...
          <div class="flex items-center">
            <div class="flex-shrink-0">
              <a href="/" class="flex items-center">
                <h1 class="text-xl font-bold text-gray-800">Jean Malan</h1>
              </a>
            </div>
            ...
            <div class="hidden md:flex ml-8 space-x-8">
              ...
              <a href="/blog" class="text-gray-600 hover:text-gray-900 px-3 py-2 text-sm font-medium">Blog</a>
          ...
          <div class="hidden md:flex items-center space-x-4">
            ...
            <a href="#" aria-label="LinkedIn" class="text-gray-500 hover:text-gray-700">
              <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"></path>
              </svg>
            </a>
            <a href="#" aria-label="GitHub" class="text-gray-500 hover:text-gray-700">
              <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div class="md:hidden">
            <button 
              @click="isOpen = !isOpen" 
              class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-black"
            >
      ...
      <div v-if="isOpen" class="md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
          ...
          <a href="/about" class="block px-3 py-2 text-base font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md">About</a>
